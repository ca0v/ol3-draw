...
define("examples/measure", ["require", "exports", "examples/mapmaker", "index"], function (require, exports, mapmaker_1, index_3) {
    ...
    function run() {
        ...
        index_3.Draw.create({ map: map, geometryType: "MultiPolygon", position: "top-2 right" });
        index_3.Measurement.create({
            map: map,
            draw: index_3.Draw.create({ map: map, geometryType: "MultiLineString" }),
            edit: index_3.Modify.create({ map: map, position: "top right-2" }),
            uom: "mi"
        });
    }
    exports.run = run;
...
define("examples/ol3-history", ["require", "exports", "index", "examples/mapmaker"], function (require, exports, index_5, mapmaker_3) {
    ...
    function run() {
        ...
        index_5.Button.create({ map: map, label: "<<", eventName: "nav:back", title: "Back", position: "left-2 top" });
        index_5.Button.create({ map: map, label: ">>", eventName: "nav:forward", title: "Forward", position: "left-4 top" });
    }
    exports.run = run;
});
define("examples/index", ["require", "exports", "examples/measure", "examples/ol3-draw", "examples/ol3-history"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function run() {
